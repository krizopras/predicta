...
class NesineAdvancedPredictor:
    ...
    def fetch_nesine_matches(self) -> List[Dict]:
        """main.py'deki periodic_data_update tarafından çağrılacaktır."""
        # Burada veri çekme ve işleme kodu olmalıdır. (Logda 0 çekildiği görülmüştü)
        return []
    ...
    # 🟢 MS/SKOR TUTARLILIĞINI SAĞLAYAN DÜZELTİLMİŞ FONKSİYON
